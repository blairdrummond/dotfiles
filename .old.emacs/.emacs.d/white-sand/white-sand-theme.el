 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'white-sand
	...
	`(cursor ((,class (:background ,bg3))))
        ...
        `(mode-line ((,class (:box nil :foreground ,fg4 :background ,nil))))
        `(mode-line-inactive ((,class (:box nil :foreground ,key3 :background ,nil :weight normal))))
